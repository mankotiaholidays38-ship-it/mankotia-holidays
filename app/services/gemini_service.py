...
# Import the schema from the new location (used implicitly in the prompt structure, we don't need the actual Pydantic classes here unless we validate locally)
...
SYSTEM_PROMPT = (
    ...
    "CRITICAL DAY COUNT RULE: The customer has requested an itinerary for EXACTLY {days} days. "
    "You MUST generate exactly {days} day objects in the 'days' array. Do NOT generate more or fewer days. "
    "The itinerary MUST start on Day 1 and MUST conclude on Day {days}.\n"
